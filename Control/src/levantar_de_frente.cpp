...
dxl_write_word(3, P_GOAL_POSITION_L,StandupPos[2]+550);//550

dxl_write_word(6, MOVING_SPEED, 400);
dxl_write_word(6, P_GOAL_POSITION_L,StandupPos[5]-550);//550
...
dxl_write_word(14, MOVING_SPEED, 300);
dxl_write_word(14, P_GOAL_POSITION_L, StandupPos[13] - 200);//606 //200
...
dxl_write_word(20, MOVING_SPEED, 300);
dxl_write_word(20, P_GOAL_POSITION_L, StandupPos[19] + 182);//401   //182
...
dxl_write_word(5, MOVING_SPEED, 200*2);
dxl_write_word(5, P_GOAL_POSITION_L, StandupPos[4]+ 160);

dxl_write_word(8, MOVING_SPEED, 200*2);
dxl_write_word(8, P_GOAL_POSITION_L, StandupPos[7] - 160);

dxl_write_word(3, MOVING_SPEED, 400*2);
dxl_write_word(3, P_GOAL_POSITION_L,StandupPos[2]+0);

dxl_write_word(6, MOVING_SPEED, 400*2);
dxl_write_word(6, P_GOAL_POSITION_L,StandupPos[5]-0);

usleep(120000);

dxl_write_word(14, MOVING_SPEED, 300);
dxl_write_word(14, P_GOAL_POSITION_L, StandupPos[13] - 175);//606 //200

dxl_write_word(20, MOVING_SPEED, 300);
dxl_write_word(20, P_GOAL_POSITION_L, StandupPos[19] + 167);//401   //182


usleep(100000);
//espera_mov_levantar();

dxl_write_word(5, MOVING_SPEED, 500);
dxl_write_word(5, P_GOAL_POSITION_L, StandupPos[4]- 60);

dxl_write_word(8, MOVING_SPEED, 500);
